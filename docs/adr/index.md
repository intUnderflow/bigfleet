...
| [56](/adr/0056-node-join-readiness-gates-coverage-credit/) | Proposed | Coverage credit gated on observed node readiness, not provider-asserted Configured — closes the silent false-Configured → phantom-capacity hole (S1 of the 2026-06-22 networking review) that bootstrapSuccessRatio (reported failures) and ADR-0033 (ramp throughput) do not cover; options: provider-verify / shard-readback / two-phase credit (author decision required) |
