...
func (x *CreateRequest) GetShardId() string {
	if x != nil {
		return x.ShardId
	}
	return ""
...
func (x *CreateRequest) GetShardEpoch() int64 {
	if x != nil {
		return x.ShardEpoch
	}
	return 0
...
func (x *CreateRequest) GetSequenceNumber() int64 {
	if x != nil {
...
func (x *ConfigureRequest) GetShardId() string {
	if x != nil {
		return x.ShardId
	}
	return ""
...
func (x *ConfigureRequest) GetShardEpoch() int64 {
	if x != nil {
		return x.ShardEpoch
	}
	return 0
...
func (x *ConfigureRequest) GetSequenceNumber() int64 {
	if x != nil {
		return x.SequenceNumber
	}
	return 0
...
func (x *DrainRequest) GetShardId() string {
	if x != nil {
		return x.ShardId
	}
	return ""
...
func (x *DrainRequest) GetShardEpoch() int64 {
	if x != nil {
		return x.ShardEpoch
	}
	return 0
...
func (x *DrainRequest) GetSequenceNumber() int64 {
	if x != nil {
		return x.SequenceNumber
	}
	return 0
...
func (x *DeleteRequest) GetMachineId() string {
	if x != nil {
		return x.MachineId
	}
	return ""
...
func (x *DeleteRequest) GetShardEpoch() int64 {
	if x != nil {
		return x.ShardEpoch
	}
	return 0
...
func (x *DeleteRequest) GetSequenceNumber() int64 {
	if x != nil {
		return x.SequenceNumber
	}
	return 0
...
func (x *TransitionAck) Reset() {
	*x = TransitionAck{}
	mi := &file_bigfleet_v1alpha1_provider_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TransitionAck) Descriptor() ([]byte, []int) {
	return file_bigfleet_v1alpha1_provider_proto_rawDescGZIP(), []int{10}
}
...
const file_bigfleet_v1alpha1_provider_proto_rawDesc = "" +
	...
	"\brevision\x18\x02 \x01(\fR\brevision\"\x99\x01\n" +
	"\n" +
	"ListFilter\x127\n" +
	"\x06states\x18\x01 \x03(\x0e2\x1f.bigfleet.v1alpha1.MachineStateR\x06states\x12\x1f\n" +
	"\vmax_results\x18\x04 \x01(\x05R\n" +
	"maxResults\x12%\n" +
	"\x0esince_revision\x18\x05 \x01(\fR\rsinceRevisionJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04\"\x99\x01\n" +
	...
	"\x0ebootstrap_blob\x18\x03 \x01(\fR\rbootstrapBlob\x12\x19\n" +
	...
	"\x14grace_period_seconds\x18\x02 \x01(\x03R\x12gracePeriodSeconds\x12\x19\n" +
	"\bshard_id\x18\x03 \x01(\tR\ashardId\x12\x1f\n" +
	"\vshard_epoch\x18\x04 \x01(\x03R\n" +
	"shardEpoch\x12'\n" +
	"\x0fsequence_number\x18\x05 \x01(\x03R\x0esequenceNumber\"\x93\x01\n" +
	"\rDeleteRequest\x12\x1d\n" +
	"\n" +
	"machine_id\x18\x01 \x01(\tR\tmachineId\x12\x19\n" +
	"\bshard_id\x18\x02 \x01(\tR\ashardId\x12\x1f\n" +
	"\vshard_epoch\x18\x03 \x01(\x03R\n" +
	"shardEpoch\x12'\n" +
	"\x0fsequence_number\x18\x04 \x01(\x03R\x0esequenceNumber\"h\n" +
	"\rTransitionAck\x12!\n" +
	...
	"\x12CAPACITY_TYPE_SPOT\x10\x042\xd7\x03\n" +
	...
	"\x05Drain\x12\x1f.bigfleet.v1alpha1.DrainRequest\x1a .bigfleet.v1alpha1.TransitionAck\x12L\n" +
	"\x06Delete\x12 .bigfleet.v1alpha1.DeleteRequest\x1a .bigfleet.v1alpha1.TransitionAck\x12@\n" +
...
var file_bigfleet_v1alpha1_provider_proto_goTypes = []any{
	...
	(*DeleteRequest)(nil),    // 11: bigfleet.v1alpha1.DeleteRequest
