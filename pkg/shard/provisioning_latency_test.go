...
func TestObserveRolledUpDemand_PreservesFirstSeen(t *testing.T) {
	...
	s.observeRolledUpDemand("cluster-x", []needs.Need{{ClusterID: "cluster-x", Profile: p, Count: 1}})
	...
	s.observeRolledUpDemand("cluster-x", []needs.Need{{ClusterID: "cluster-x", Profile: p, Count: 5}})
...
func TestObserveRolledUpDemand_PrunesAbsent(t *testing.T) {
	...
	s.observeRolledUpDemand("cluster-x", []needs.Need{
		{ClusterID: "cluster-x", Profile: p1, Count: 1},
		{ClusterID: "cluster-x", Profile: p2, Count: 1},
	})
