...
// on every call.
//
// These helpers convert quantities to int64 milli-units once at a
// chosen boundary (typically the bucket build in takeCoLocated). All
// hot-path arithmetic then runs on plain int64s with zero allocations.
