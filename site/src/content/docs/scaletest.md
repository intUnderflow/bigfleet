---
title: "BigFleet scale-test runbook"
description: "How to run a BigFleet scale test against any Kubernetes cluster — kind on a laptop, your homelab, GKE Autopilot, EKS spot."
---
...
3. If it deserves a baseline number, capture the resulting `summary.json` under `test/scaletest/results/baseline-<name>.json` and reference it in [`scaling-guide.md`](/scaling-guide/).
...
- Sizing rationale: [`scaling-guide.md`](/scaling-guide/)
- Production install: [`operator-guide.md`](/operator-guide/)
- Plan §5.1 (scale ceilings): [`plan.md`](/plan/)
