...
hero:
  ...
  actions:
    - text: Demo
      link: https://bigfleet-demo.lucy.sh
      icon: right-arrow
      variant: primary
      attrs:
        data-demo-cta: "true"
...
import DemoGate from "../../components/DemoGate.astro";
...
- **Wondering about networking?** → BigFleet expresses networking needs as capacity *requirements* rather than modelling the network → [BigFleet and networking](/networking/).
