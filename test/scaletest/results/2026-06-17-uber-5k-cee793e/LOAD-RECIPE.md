...
This bundle's `tsdb-snapshot.tar.gz ([download](https://github.com/intUnderflow/bigfleet-uber/releases/download/uber-5k-cee793e-receipt-20260620/tsdb-snapshot.tar.gz))` is a full Prometheus TSDB (the combined hub+satellite
