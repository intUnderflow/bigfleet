...
This bundle's `tsdb-snapshot.tar.gz ([download](https://github.com/intUnderflow/bigfleet-uber/releases/download/failover-partition-soak-2shard-receipt-20260620/tsdb-snapshot.tar.gz))` is a full Prometheus TSDB (the combined hub+satellite
