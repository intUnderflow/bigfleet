...
This bundle's `tsdb-snapshot.tar.gz ([download](https://github.com/intUnderflow/bigfleet-uber/releases/download/reclaim-205fb99-receipt-20260620/tsdb-snapshot.tar.gz))` is a full Prometheus TSDB (the combined hub+satellite
