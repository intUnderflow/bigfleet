# uber-50k reproducibility receipt #3 — FAITHFUL cee793e (#88)
...
`2026-06-18-uber-50k-run3-cee793e`.
...
| operatorNodeStateUpdateP99 | <=1.5s | **0.88s** | 0.873s |
| operatorRollupP99 | <=1s | **0.93s** | 0.757s |
| operatorAckP99 | <=12s | **1.10s** | 1.28s |
...
## Artifacts
`tsdb-snapshot.tar.gz` (RELEASE ASSET, see `https://github.com/intUnderflow/bigfleet/releases/download/scaletest-receipts-uber50k-20260621/tsdb-uber-50k-run3-cee793e.tar.gz`): hub + one-sat-per-region TSDB sample.
