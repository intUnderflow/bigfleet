...
This bundle's `tsdb-snapshot.tar.gz` (release asset — see `https://github.com/intUnderflow/bigfleet/releases/download/scaletest-receipts-uber50k-20260621/tsdb-uber-50k-run3-cee793e.tar.gz`) is a full Prometheus TSDB:
