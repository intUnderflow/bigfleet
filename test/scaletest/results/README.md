...
| homelab-500k | — | — | — | — | — | — | — | **unblocked** by M11.16. Bench at 500K seeded inventory + 50K demand: cycle dropped from ~948 s (pre-M11.15) → 245 ms at 50K and 2.15 s at 500K (441× speedup at 500K). 500K is over the 100 ms cycle SLO but the bench is worst-case (10% utilisation, 5 fingerprints). Real-cluster baseline is the next step. |
