...
| **scaleway-500k** | [20260502-022847-scaleway-500k-m1117](20260502-022847-scaleway-500k-m1117/) | **4.07 s** | 16 ms | 493 ms | 50,000 demand / 500,000 inventory | 50 | ✗ | M11.17 + LocalBootstrap. Shard CPU now sustained at 2 vCPU (was 284 m blocked on stream RTT), `shortfalls=0`, demand fully satisfied. The 4 s shard cycle now reflects *real* compute — Phase 1/2/3 walking 500K inventory at ~2× the M5 Max bench (Scaleway PRO2 is slower per single-thread op). Honest reading: at the 100 ms cycle SLO, per-shard ceiling on this hardware is ~25K machines, not 500K. Cost: ~$0.95 on a 5× PRO2-M Scaleway nl-ams cluster. |
